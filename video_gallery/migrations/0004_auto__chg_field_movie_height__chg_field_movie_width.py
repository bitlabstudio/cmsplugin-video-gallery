...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Movie.height'
        db.alter_column('video_gallery_movie', 'height', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'Movie.width'
        db.alter_column('video_gallery_movie', 'width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Movie.height'
        raise RuntimeError("Cannot reverse this migration. 'Movie.height' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Movie.width'
        raise RuntimeError("Cannot reverse this migration. 'Movie.width' and its values cannot be restored.")
    ...
    models = {
        ...
        'video_gallery.movie': {
            'Meta': {'ordering': "('date',)", 'object_name': 'Movie'},
            'auto_hide': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'auto_play': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['video_gallery.Category']", 'null': 'True', 'blank': 'True'}),
